...
class QualificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create qualification" do
    assert_difference('Qualification.count') do
      post qualifications_url, params: { qualification: { completed: @qualification.completed, fieldofStudy: @qualification.fieldofStudy, institution: @qualification.institution, lengthofQualificatin: @qualification.lengthofQualificatin, qualificationType: @qualification.qualificationType, yearOfStudy: @qualification.yearOfStudy } }
    end
  ...
  test "should update qualification" do
    patch qualification_url(@qualification), params: { qualification: { completed: @qualification.completed, fieldofStudy: @qualification.fieldofStudy, institution: @qualification.institution, lengthofQualificatin: @qualification.lengthofQualificatin, qualificationType: @qualification.qualificationType, yearOfStudy: @qualification.yearOfStudy } }
